package at.ac.tuwien.actions.test;
...
public class ExternalToolExecuterTest {

    private static final String ADMIN_USER_NAME = "admin";

    static Logger log = Logger.getLogger(ExternalToolExecuterTest.class);
...
//    	Action action = actionService.createAction("external-tool");
...
//
//        // assign name
//        String name = "Execute External Tool Test (" + System.currentTimeMillis() + ")";
...
//
//    	Action action = actionService.createAction("external-tool");
//    	action.setParameterValue("fits", "fits");
